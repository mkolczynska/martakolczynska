...
The last thing I will do is to plot the country coverage of the Master File subset on the world map. As a reminder, this is the subset that contains surveys with all of the following variables: gender, age, education (completed levels of schooling years), rural residence, trust in parliament, and participation in demonstrations "ever".
...
mapCountryData( map, catMethod = "categorical",
                ...
                mapTitle = "Country coverage of the SDR Master File subset")  
