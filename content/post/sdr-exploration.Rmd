...
The SDR data bundle version 1.0 (Master Box v.1.0) is available from [Dataverse](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/VWGF5Q){target="_blank"}. Thanks to the `dataverse` package, these data can be loaded directly to R.
