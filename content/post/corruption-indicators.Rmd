...
3. Control of Corruption in the World Bank's [Worldwide Governance Indicators, WGI](https://info.worldbank.org/governance/wgi/)
...
```{r eval = F, echo = F}
### V-dem -----------
vdem <- readRDS("C:/Users/mkolc/Google Drive/Work in progress/2018-2020/EVS trust governance/V-Dem-CY-Core-v10.rds") %>%
  filter(year >= 1990) %>%
...
wgi <- import("C:/Users/mkolc/Google Drive/Work in progress/2018-2020/EVS trust governance/WGI.xlsx") %>%
