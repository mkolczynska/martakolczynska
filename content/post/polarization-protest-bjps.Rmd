...
I have not attempted to reproduce the measures of polarization, as this would require 
downloading the numerous survey data files, digging through the documentation, and 
generally a lot of work. As a side note: including variables constructed by 
aggregating survey data as predictors in regression models requires accounting for the 
measurement uncertainty of these aggregates and omitting them, as Griffin et al. did, 
leads to biased results 
(see [Tai, Hu, and Solt 2022](https://doi.org/10.1017/S0003055422000429)).
...
combo <- polarization %>%
  ...
  mutate(demons_strike = demons + strike,
...
BJPS in Mat 2024, and nothing has been done yet.
