...
categories: ["R"]
tags: ["biking", "hackathon", "big data", "Barcelona"]
output:
  blogdown::html_page:
    toc: true
    toc_depth: 4
...
To see how systematic these differences are, we divided the stations into three groups by altitude: below 50 m a.s.l., 50-99 m, and 100 meters or higher, and plotted the proportion of time the stations were empty each day for all days in September. As the below graph shows, stations located highest (in red) are empty most often, while stations located al lowest altitudes (in green) are seldom empty.

This is probably because bike use and bike replenishment are out of sync and leave some of the stations without bikes most of the time.
