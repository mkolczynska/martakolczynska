...
The TED talk dataset on Kaggle includes more information that would be interesting to analyze, including tags (key words), ratings, the number of comments, that's material for another post, perhaps.
