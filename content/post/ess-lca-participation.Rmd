...
Ahead of Poland's local government elections, I'm interested in looking at regional differences in participation. The ESS provides sub-national region identifiers in the NUTS classification (where available). In the Polish dataset regions are defined at the NUTS2 level, corresponding to 16 *województwa*. The three maps below show the proportions of each class - "Activists", the "Disengaged", and "Protesters" - by region.
