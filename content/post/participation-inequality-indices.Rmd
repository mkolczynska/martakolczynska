...
names(read.xlsx(file = tmp, sheetIndex = 2)) # reads column names from the second sheet
...
for (i in 1:13) {
  ...
  fh.list[[i]]$year <- 2018 - i + 1 # adds year column
}
...
The final dataset can be saved to a C file for future use.
